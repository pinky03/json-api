...
class UserServiceTest extends TestCase
{
    ...
    {
        $this->users->shouldReceive('all')->andReturn(collect([]));
    ...
    {
        $this->events->shouldReceive('find')->andReturn($this->users);
        $this->users->shouldReceive('getAttribute')->andReturn(collect([]));
    ...
    public function testLogIn()
    {
        ...
        $this->users->shouldReceive('where')->andReturn($this->users);
        $this->users->shouldReceive('update')
            ->shouldReceive('first')
            ->andReturn($this->users);
        $this->users->shouldReceive('getAttribute')->andReturn('password');
    ...
    {
        $this->users->shouldReceive('create')->andReturn($this->users);
